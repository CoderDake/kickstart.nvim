return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>gs', neogit.open, { desc = '[G]it [S]tatus', silent = true, noremap = true })
    ...
    vim.keymap.set('n', '<leader>doM', ':DiffviewOpen origin/main...<CR>', { desc = '[D]iff [O]rigin/[M]ain' })
  end,
}
