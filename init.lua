...
-- Quickfix keymaps
vim.keymap.set('n', '[q', '<cmd>cprev<CR>zz', { desc = 'Quickfix [p]rev' })
vim.keymap.set('n', ']q', '<cmd>cnext<CR>zz', { desc = 'Quickfix [n]ext' })
vim.keymap.set('n', '<leader>cc', '<cmd>ccl<CR>zz', { desc = 'Quickfix [c]lose' })
